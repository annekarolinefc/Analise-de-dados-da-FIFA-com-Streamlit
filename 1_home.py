...
if "data" not in st.session_state:
    ...
    df_data = df_data[df_data["Contract Valid Until"] >= datetime.today().year] # somente jogadores com contrato valido
    df_data = df_data[df_data["Value(£)"] > 0]
    df_data = df_data.sort_values(by="Overall", ascending=False)
    st.session_state["data"] = df_data

st.markdown("# FIFA 2023 | OFFICIAL DATASET  ")
st.sidebar.markdown("Desenvolvido por [Anne Carmo](https://www.linkedin.com/in/devannekarolinefc/)")
